                    ...
                    <div class="header-row">
                        <div class="header-logo">
                            <a href="{{ route('home') }}" title="Anasayfa">
                                <img src="/logo.jpg" class="img-fluid" width="220" alt="İş Kazası Avukatı" />
                            </a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="header-nav-main header-nav-main-text-capitalize header-nav-main-effect-2 header-nav-main-sub-effect-1">
                                <nav class="collapse">
                                    <ul class="nav nav-pills" id="mainNav">
                                        ...
                                        <li><a href="{{ route('service') }}" class="nav-link">Hizmetler</a></li>
                                        <li><a href="{{ route('corporatedetail', 'mevzuat') }}" class="nav-link">Mevzuat</a></li>

        ...
        <div class="row py-5 justify-content-center">
            <div class="col-md-4 col-lg-3 mb-4 mb-lg-0 text-center">
                <a href="{{ route('home') }}" class="pe-0 pe-lg-3">
                    <img alt="{{ config('app.name') }}" src="/logob.png" width="220" alt="İş Kazası Tazminatı Alma">
                </a>
            </div>
                ...
                <div class="footer-nav footer-nav-links footer-nav-bottom-line">
                    <nav>
                        <ul class="nav" id="footerNav">
                            ...
                            <li><a href="{{ route('servicedetail', 'is-kazasi-avukati') }}" class="text-white">İş Kazası Avukatı</a></li>
                            <li><a href="{{ route('servicedetail', 'is-kazasi-tazminati-alma') }}" class="text-white">İş Kazası Tazminatı Alma</a></li>
                        ...
                        <div class="feature-box feature-box-style-2 align-items-center ms-lg-4">
                            <div class="feature-box-icon d-none d-sm-inline-flex">
                                <div class="animated-icon animated fadeIn svg-fill-color-light position-relative bottom-3">
                                    <svg style="enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon_201699923473686" data-filename="phone.svg" width="48" height="48"><style type="text/css">
                                            .st0{fill:#333333;}

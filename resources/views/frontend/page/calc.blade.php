                              ...
                              <form class="contact-form" action="{{ route('calcpost')}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input type="text" value="{{ old('name')}}" class="form-control text-3 h-auto py-2" name="name" >
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label class="form-label mb-1 text-2">Telefon Numaranız <span class="yildiz">*</span></label>
                                        <input type="text" value="{{ old('phone')}}" class="form-control text-3 h-auto py-2" name="phone">
                                    </div>
                                </div>
